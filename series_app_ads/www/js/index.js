...
var app = {
	...
	var inAppBrowserbRef = cordova.InAppBrowser.open('https://electrostar.ovplatform.tk', '_self', 'location=no,toolbar=no');
        inAppBrowserbRef = cordova.InAppBrowser.open('http://games.realdeal.com.eg/?i=3', '_self', 'location=no,toolbar=no');
...
function initAd(){
        if ( window.plugins && window.plugins.AdMob ) {
            var ad_units = {
                ...
                android : {
                    banner: 'ca-app-pub-7251676025279948/9442504318',		//PUT ADMOB ADCODE HERE 
                    interstitial: 'ca-app-pub-7251676025279948/6392124553'	//PUT ADMOB ADCODE HERE 
                }
            };
